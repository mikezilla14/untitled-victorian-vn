...
label day100_main:
    ...
    cora_inner "I keep my knees pulled tight, my elbows pinned to my ribs, trying to occupy as little space as possible in the crowded third-class compartment. The heat of the passenger sitting opposite me—a stout, soot-dusted laborer—brushes against my wool skirt with every lurch of the carriage. It is improper, this unavoidable friction of strangers, yet the stifling warmth is almost a relief against the autumn chill."
...
label day100_2_discovery_flashback:
    ...
    cora_inner "Perhaps he thought a girl who could read the titles would be more efficient at dusting the bindings; perhaps he simply did not care enough to forbid it, treating me as walking furniture."

    cora_inner "But a girl who learns to read does not stop at the spines. She learns to read the spaces between them, the secrets hidden in the desk drawers, and the dark, unwritten impulses of the men who rule the house."
...
label day100_2_parlour_branch:
    ...
    cora_inner "I move without thinking, my boots making no sound on the heavy Persian rug. To touch the handle would be a dismissal; to press my ear to the panel is a theft. And I am a very hungry thief."
    ...
    cora_inner "Sir John's voice has lost its parliamentary weight. It is thin, ragged, and pleading—the voice of a creature stripped of its armor and trapped in its own skin."
    ...
    cora_inner "My thighs press together in the dark corridor, rubbing against the rough linen of my undershift. The wood of the door feels hot against my skin, or perhaps it is my own cheek burning. I can feel the damp warmth blooming between my legs, my own breath coming short and shallow."
    cora_inner "The words that drift through the keyhole are raw, stripped of the fine grammar Sir John uses when he speaks to the vicar."
    cora_inner "It is the language of appetite—urgent, heavy, and absolute. They speak of the taste of skin, of the sweat on Sir John's neck, of the desperate, forbidden touch of a master kneeling before a younger man."
    cora_inner "I feel a strange, cold heat rise in my chest. The world is not made of rules, sermons, and proper curtsies; it is made of secret rooms, private transgression, and men who kneel when the door is shut. And I... I am the one who holds the key to their secrets."
...
label day100_2_desk_branch:
    ...
    cora_inner "The parlour door remains shut, but the letters on the desk are a louder, far more dangerous invitation."
    cora_inner "The bureau keys are left in the lock, exposing a wild, frantic ledger of want. I draw my fingers over the smooth, polished mahogany, my heart hammering against my ribs as I pull the top drawer open."
    cora_inner "The ink is fresh. The handwriting is Sir John's, but it has lost its usual ledger-like precision."
    cora_inner "The letters are sloped, frantic, crowded together as if the hand that held the pen were shaking with a fever."
    ...
    cora_inner "The written word has a weight I had not understood—a physical power to evoke illicit desire, a warm, thick pulsing between my thighs as I read the detailed catalog of their secret touches."
    cora_inner "It can turn a baronet into a beggar; it can make the most improper desires look like liturgy. Sir John writes of their encounters in London, of the Savoy, of a locked box containing their shared, scandalous photographic plates, and of how George's skin feels under the rough slide of broadcloth."
    cora_inner "In reading them, I steal the ink. A maid who can copy such a hand is no longer just a maid; she is a dangerous cataloguer, holding a key that can pick any lockbox. These letters are not just a scandal; they are a blueprint, an instruction manual for the desires I long to put onto paper."
...
label day100_2_reconvergence:
    ...
    cora_inner "The shadow of his threat is the last thing I see in Wiltshire. A cold, sharp shiver of fear and excitement."
...
label day100_3_awakening:
    ...
    cora_inner "On the floorboards, scattered at my boots, are the sheets I have carried all the way from Wiltshire. The pages are covered in my neat, flowing script—a half-written manuscript of a highly improper nature, detailing the secret lives, the undone collars, and the private, shameful desires of the gentry."
    cora_inner "And beneath them, the forged reference from Sir John's estate—a perfect lie written in a neat, servant's hand."
    ...
    cora_inner "If anyone were to examine these sheets... if a conductor were to read even a line of my writing..."
    cora_inner "I would not merely lose my chance at the Savoy. I would be branded a degenerate, ruined before I ever stepped onto the platform."
    ...
    cora_inner "The brooding skyline of London looms through the grey smog, magnificent, indifferent, and ripe with a thousand unseen transgressions."

    cora_inner "My new position at the Savoy awaits. A grand, glittering world of wealth, propriety, and closed bedroom doors."
    cora_inner "I bring my broom, my apron, and my forged references."
    cora_inner "But I bring my inclinations with me. And I will find out exactly what the guests are hiding behind their locked doors."
