...
Ad-hoc spice comparisons and throwaway tries: `narrative/pipeline/experiments/` only.

## Promotion path

Approved prose lives in `narrative/draft/releases/<slug>/days/<day>/dayrdd_non_canon.rpy`. Runtime canon: `renpy_project/game/dayrdd.rpy`.
