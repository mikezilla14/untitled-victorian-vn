...
- **`missy_day1_trust_state`:**
  - *`soothed`:* Pacified Miri with soft, grease-soft lies. Miri sleeps soundly, unaware of the butcher's count.
  - *`unsettled`:* Miri's trust is shattered. Used as a shield in the corridor; she shivers at rising steam, knowing she could be boiled for tallow.
...
## 5. Prose Output Format Constraints
