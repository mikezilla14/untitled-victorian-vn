...
**Canonical location:** This file (`docs/dev_bible.md`). Agent rule stub: [`.agents/rules/dev_bible.md`](../.agents/rules/dev_bible.md).
...
- `dayrxx.rpy`, `endings.rpy`, `story_chains.rpy`: narrative flow and branch content (`r` = release, `xx` = 2-digit day).
