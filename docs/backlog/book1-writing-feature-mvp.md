...
- Non-prod Book1 engine/routing lives in `main-game/non-prod-game/game/days/book1_non_canon.rpy`.
...
Do not commit `non_prod_main-game/prod-game/game/cache/shaders.txt`.
