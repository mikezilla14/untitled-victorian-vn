...
| Testing and balance framework | `required-mvp` | No direct runtime logic until harnessed | `scripts/balance_report.py`, `scripts/validation/balance_report_impl.py`, `main-game/draft/releases/planning/testing_balance_framework_spec.md`, `main-game/pipeline/releases/release-1-mvp/reports/balance_report.md` | `chief_architect`, documentation steward | `py scripts/balance_report.py --release release-1-mvp` (static report; not a storyboard replacement) | Keep. **Implemented:** first-pass static report (2026-06-19). Next review: wire grain manifest + policy simulator; connect P1–P7 matrix evidence. |
