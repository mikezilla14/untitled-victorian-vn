...
init -35 python:
    ...
    def preferences_content_xoffset():
        """Shift preferences right of the nav column, centered in remaining width."""
        content_area = config.screen_width - 280
        block_width = 900
        return max(40, (content_area - block_width) // 2)
...
screen preferences():
    ...
    use game_menu(_("Preferences"), scroll="viewport"):
        ...
        $ _prefs_xoffset = preferences_content_xoffset()
