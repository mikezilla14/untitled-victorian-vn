...
8. **Filename contract enforcement.** Reject PRs that create or modify episodic files outside the naming contract: `dayrxx_non_canon.md` for drafts and `dayrxx.rpy` for runtime (`r` = release, `xx` = 2-digit day).
